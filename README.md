...
`apps/mobile` is an exploratory React Native client (Expo Router). It is **prototype UI only** — no API, auth, or shared data layer yet. It does not replace the PWA.
