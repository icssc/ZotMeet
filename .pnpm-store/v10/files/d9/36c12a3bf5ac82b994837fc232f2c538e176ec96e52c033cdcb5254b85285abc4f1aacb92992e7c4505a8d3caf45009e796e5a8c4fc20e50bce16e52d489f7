...
export declare namespace chat_v1 {
    ...
    export class Resource$Users$Spaces$Spacenotificationsetting {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Users$Spaces$Spacenotificationsetting$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Users$Spaces$Spacenotificationsetting$Get, options?: MethodOptions): GaxiosPromise<Schema$SpaceNotificationSetting>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Users$Spaces$Spacenotificationsetting$Patch, options: StreamMethodOptions): GaxiosPromise<Readable>;
        patch(params?: Params$Resource$Users$Spaces$Spacenotificationsetting$Patch, options?: MethodOptions): GaxiosPromise<Schema$SpaceNotificationSetting>;
