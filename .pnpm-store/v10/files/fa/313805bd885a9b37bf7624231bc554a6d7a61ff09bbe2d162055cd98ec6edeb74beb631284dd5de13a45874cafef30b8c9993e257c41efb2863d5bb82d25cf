...
var UniqueConstraintBuilder = class {
	static [__entity_ts.entityKind] = "MsSqlUniqueConstraintBuilder";
	/** @internal */
	columns;
...
var UniqueOnConstraintBuilder = class {
	static [__entity_ts.entityKind] = "MsSqlUniqueOnConstraintBuilder";
	/** @internal */
	name;
	constructor(name) {
		this.name = name;
...
var UniqueConstraint = class {
	static [__entity_ts.entityKind] = "MsSqlUniqueConstraint";
	columns;
	name;
