...
export declare namespace assuredworkloads_v1beta1 {
    ...
    export class Resource$Organizations$Locations$Workloads$Updates {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        apply(params: Params$Resource$Organizations$Locations$Workloads$Updates$Apply, options: StreamMethodOptions): GaxiosPromise<Readable>;
        apply(params?: Params$Resource$Organizations$Locations$Workloads$Updates$Apply, options?: MethodOptions): GaxiosPromise<Schema$GoogleLongrunningOperation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Organizations$Locations$Workloads$Updates$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Organizations$Locations$Workloads$Updates$List, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudAssuredworkloadsV1beta1ListWorkloadUpdatesResponse>;
