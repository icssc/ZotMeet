...
export declare namespace iamcredentials_v1 {
    ...
    export class Resource$Projects$Serviceaccounts {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getAllowedLocations(params: Params$Resource$Projects$Serviceaccounts$Getallowedlocations, options: StreamMethodOptions): GaxiosPromise<Readable>;
        getAllowedLocations(params?: Params$Resource$Projects$Serviceaccounts$Getallowedlocations, options?: MethodOptions): GaxiosPromise<Schema$ServiceAccountAllowedLocations>;
