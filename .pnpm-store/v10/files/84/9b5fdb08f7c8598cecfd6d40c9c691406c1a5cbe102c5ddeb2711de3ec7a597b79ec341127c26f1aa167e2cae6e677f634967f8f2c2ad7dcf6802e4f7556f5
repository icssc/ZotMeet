...
export declare namespace paymentsresellersubscription_v1 {
    ...
    export class Resource$Partners$Usersessions {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        generate(params: Params$Resource$Partners$Usersessions$Generate, options: StreamMethodOptions): GaxiosPromise<Readable>;
        generate(params?: Params$Resource$Partners$Usersessions$Generate, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudPaymentsResellerSubscriptionV1GenerateUserSessionResponse>;
