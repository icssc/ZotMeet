...
//#region src/gel-core/columns/custom.d.ts
...
interface GelCustomColumnInnerConfig {
  customTypeValues: CustomTypeValues;
}
declare class GelCustomColumnBuilder<T extends ColumnBuilderBaseConfig<'custom'>> extends GelColumnBuilder<T, {
...
declare class GelCustomColumn<T extends ColumnBaseConfig<'custom'>> extends GelColumn<T> {
  static readonly [entityKind]: string;
  private sqlName;
  private mapTo?;
  private mapFrom?;
...
declare function customType<T extends CustomTypeValues = CustomTypeValues>(customTypeParams: CustomTypeParams<T>): Equal<T['configRequired'], true> extends true ? {
  ...
  (dbname: string, fieldConfig: T['config']): GelCustomColumnBuilder<ConvertCustomConfig<T>>;
} : {
...
//#endregion
export { ConvertCustomConfig, CustomTypeParams, CustomTypeValues, GelCustomColumn, GelCustomColumnBuilder, GelCustomColumnInnerConfig, customType };
