...
export declare namespace playdeveloperreporting_v1beta1 {
    ...
    export class Resource$Vitals$Lmkrate {
        ...
        get(params?: Params$Resource$Vitals$Lmkrate$Get, options?: MethodOptions): GaxiosPromise<Schema$GooglePlayDeveloperReportingV1beta1LmkRateMetricSet>;
        ...
        query(params?: Params$Resource$Vitals$Lmkrate$Query, options?: MethodOptions): GaxiosPromise<Schema$GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetResponse>;
