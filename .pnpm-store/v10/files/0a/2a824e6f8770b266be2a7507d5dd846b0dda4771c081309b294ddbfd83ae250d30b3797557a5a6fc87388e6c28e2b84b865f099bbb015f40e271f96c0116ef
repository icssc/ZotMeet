...
export declare namespace cloudchannel_v1 {
    ...
    export class Resource$Integrators {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        registerSubscriber(params: Params$Resource$Integrators$Registersubscriber, options: StreamMethodOptions): GaxiosPromise<Readable>;
        registerSubscriber(params?: Params$Resource$Integrators$Registersubscriber, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudChannelV1RegisterSubscriberResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        unregisterSubscriber(params: Params$Resource$Integrators$Unregistersubscriber, options: StreamMethodOptions): GaxiosPromise<Readable>;
        unregisterSubscriber(params?: Params$Resource$Integrators$Unregistersubscriber, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudChannelV1UnregisterSubscriberResponse>;
