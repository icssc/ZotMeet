...
export declare namespace androidenterprise_v1 {
    ...
    export class Resource$Enterprises {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        generateEnterpriseUpgradeUrl(params: Params$Resource$Enterprises$Generateenterpriseupgradeurl, options: StreamMethodOptions): GaxiosPromise<Readable>;
        generateEnterpriseUpgradeUrl(params?: Params$Resource$Enterprises$Generateenterpriseupgradeurl, options?: MethodOptions): GaxiosPromise<Schema$GenerateEnterpriseUpgradeUrlResponse>;
