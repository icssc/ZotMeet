...
export declare namespace batch_v1 {
    ...
    export class Resource$Projects$Locations$Jobs {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        cancel(params: Params$Resource$Projects$Locations$Jobs$Cancel, options: StreamMethodOptions): GaxiosPromise<Readable>;
        cancel(params?: Params$Resource$Projects$Locations$Jobs$Cancel, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
