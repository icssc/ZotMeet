 ...
 */
declare const run: <TOpts extends Record<string, GenericBuilderInternalsLimited> | undefined = undefined>(commands: Command[], config?: BroCliConfig<TOpts>) => Promise<void>;
