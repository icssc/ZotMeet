...
export declare namespace networkconnectivity_v1 {
    ...
    export class Resource$Projects$Locations$Global$Hubs {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        acceptSpokeUpdate(params: Params$Resource$Projects$Locations$Global$Hubs$Acceptspokeupdate, options: StreamMethodOptions): GaxiosPromise<Readable>;
        acceptSpokeUpdate(params?: Params$Resource$Projects$Locations$Global$Hubs$Acceptspokeupdate, options?: MethodOptions): GaxiosPromise<Schema$GoogleLongrunningOperation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        rejectSpokeUpdate(params: Params$Resource$Projects$Locations$Global$Hubs$Rejectspokeupdate, options: StreamMethodOptions): GaxiosPromise<Readable>;
        rejectSpokeUpdate(params?: Params$Resource$Projects$Locations$Global$Hubs$Rejectspokeupdate, options?: MethodOptions): GaxiosPromise<Schema$GoogleLongrunningOperation>;
