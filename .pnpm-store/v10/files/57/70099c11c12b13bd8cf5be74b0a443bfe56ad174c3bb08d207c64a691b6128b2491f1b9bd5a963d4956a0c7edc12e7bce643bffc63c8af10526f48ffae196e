...
export declare namespace backupdr_v1 {
    ...
    export class Resource$Projects$Locations$Resourcebackupconfigs {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Resourcebackupconfigs$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Projects$Locations$Resourcebackupconfigs$List, options?: MethodOptions): GaxiosPromise<Schema$ListResourceBackupConfigsResponse>;
