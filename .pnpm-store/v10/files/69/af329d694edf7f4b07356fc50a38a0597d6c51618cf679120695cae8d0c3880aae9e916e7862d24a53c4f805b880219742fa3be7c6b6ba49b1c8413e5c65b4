...
export declare namespace workloadmanager_v1 {
    ...
    export class Resource$Projects$Locations$Discoveredprofiles {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Discoveredprofiles$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Projects$Locations$Discoveredprofiles$Get, options?: MethodOptions): GaxiosPromise<Schema$WorkloadProfile>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Discoveredprofiles$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Projects$Locations$Discoveredprofiles$List, options?: MethodOptions): GaxiosPromise<Schema$ListDiscoveredProfilesResponse>;
    ...
    export class Resource$Projects$Locations$Discoveredprofiles$Healthes {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Discoveredprofiles$Healthes$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Projects$Locations$Discoveredprofiles$Healthes$Get, options?: MethodOptions): GaxiosPromise<Schema$WorkloadProfileHealth>;
    ...
    export class Resource$Projects$Locations$Insights {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Insights$Delete, options: StreamMethodOptions): GaxiosPromise<Readable>;
        delete(params?: Params$Resource$Projects$Locations$Insights$Delete, options?: MethodOptions): GaxiosPromise<Schema$Empty>;
