...
export declare namespace displayvideo_v4 {
    ...
    export class Resource$Advertisers$Adgroups {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        bulkListAssignedTargetingOptions(params: Params$Resource$Advertisers$Adgroups$Bulklistassignedtargetingoptions, options: StreamMethodOptions): GaxiosPromise<Readable>;
        bulkListAssignedTargetingOptions(params?: Params$Resource$Advertisers$Adgroups$Bulklistassignedtargetingoptions, options?: MethodOptions): GaxiosPromise<Schema$BulkListAdGroupAssignedTargetingOptionsResponse>;
    ...
    export class Resource$Firstpartyandpartneraudiences {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Firstpartyandpartneraudiences$Create, options: StreamMethodOptions): GaxiosPromise<Readable>;
        create(params?: Params$Resource$Firstpartyandpartneraudiences$Create, options?: MethodOptions): GaxiosPromise<Schema$FirstPartyAndPartnerAudience>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        editCustomerMatchMembers(params: Params$Resource$Firstpartyandpartneraudiences$Editcustomermatchmembers, options: StreamMethodOptions): GaxiosPromise<Readable>;
        editCustomerMatchMembers(params?: Params$Resource$Firstpartyandpartneraudiences$Editcustomermatchmembers, options?: MethodOptions): GaxiosPromise<Schema$EditCustomerMatchMembersResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Firstpartyandpartneraudiences$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Firstpartyandpartneraudiences$Get, options?: MethodOptions): GaxiosPromise<Schema$FirstPartyAndPartnerAudience>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Firstpartyandpartneraudiences$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Firstpartyandpartneraudiences$List, options?: MethodOptions): GaxiosPromise<Schema$ListFirstPartyAndPartnerAudiencesResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Firstpartyandpartneraudiences$Patch, options: StreamMethodOptions): GaxiosPromise<Readable>;
        patch(params?: Params$Resource$Firstpartyandpartneraudiences$Patch, options?: MethodOptions): GaxiosPromise<Schema$FirstPartyAndPartnerAudience>;
    ...
    export class Resource$Sdfuploadtasks$Operations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Sdfuploadtasks$Operations$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Sdfuploadtasks$Operations$Get, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
