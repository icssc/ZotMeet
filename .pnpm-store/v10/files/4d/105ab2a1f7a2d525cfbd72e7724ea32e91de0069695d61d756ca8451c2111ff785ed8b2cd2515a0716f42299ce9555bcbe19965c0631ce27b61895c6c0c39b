...
export declare namespace healthcare_v1 {
    ...
    export class Resource$Projects$Locations$Datasets$Fhirstores {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        bulkExportGroup(params: Params$Resource$Projects$Locations$Datasets$Fhirstores$Bulkexportgroup, options: StreamMethodOptions): GaxiosPromise<Readable>;
        bulkExportGroup(params?: Params$Resource$Projects$Locations$Datasets$Fhirstores$Bulkexportgroup, options?: MethodOptions): GaxiosPromise<Schema$HttpBody>;
    ...
    export class Resource$Projects$Locations$Datasets$Fhirstores$Fhir {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        bulkExport(params: Params$Resource$Projects$Locations$Datasets$Fhirstores$Fhir$Bulkexport, options: StreamMethodOptions): GaxiosPromise<Readable>;
        bulkExport(params?: Params$Resource$Projects$Locations$Datasets$Fhirstores$Fhir$Bulkexport, options?: MethodOptions): GaxiosPromise<Schema$HttpBody>;
    ...
    export class Resource$Projects$Locations$Datasets$Fhirstores$Operations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        deleteFhirOperation(params: Params$Resource$Projects$Locations$Datasets$Fhirstores$Operations$Deletefhiroperation, options: StreamMethodOptions): GaxiosPromise<Readable>;
        deleteFhirOperation(params?: Params$Resource$Projects$Locations$Datasets$Fhirstores$Operations$Deletefhiroperation, options?: MethodOptions): GaxiosPromise<Schema$HttpBody>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getFhirOperationStatus(params: Params$Resource$Projects$Locations$Datasets$Fhirstores$Operations$Getfhiroperationstatus, options: StreamMethodOptions): GaxiosPromise<Readable>;
        getFhirOperationStatus(params?: Params$Resource$Projects$Locations$Datasets$Fhirstores$Operations$Getfhiroperationstatus, options?: MethodOptions): GaxiosPromise<Schema$HttpBody>;
