...
export declare namespace dfareporting_v4 {
    ...
    export class Resource$Tvcampaigndetails {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Tvcampaigndetails$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Tvcampaigndetails$Get, options?: MethodOptions): GaxiosPromise<Schema$TvCampaignDetail>;
        get(params: Params$Resource$Tvcampaigndetails$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Tvcampaigndetails$Get, options: MethodOptions | BodyResponseCallback<Schema$TvCampaignDetail>, callback: BodyResponseCallback<Schema$TvCampaignDetail>): void;
        get(params: Params$Resource$Tvcampaigndetails$Get, callback: BodyResponseCallback<Schema$TvCampaignDetail>): void;
    ...
    export class Resource$Tvcampaignsummaries {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Tvcampaignsummaries$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Tvcampaignsummaries$List, options?: MethodOptions): GaxiosPromise<Schema$TvCampaignSummariesListResponse>;
        list(params: Params$Resource$Tvcampaignsummaries$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Tvcampaignsummaries$List, options: MethodOptions | BodyResponseCallback<Schema$TvCampaignSummariesListResponse>, callback: BodyResponseCallback<Schema$TvCampaignSummariesListResponse>): void;
        list(params: Params$Resource$Tvcampaignsummaries$List, callback: BodyResponseCallback<Schema$TvCampaignSummariesListResponse>): void;
        list(callback: BodyResponseCallback<Schema$TvCampaignSummariesListResponse>): void;
    }
