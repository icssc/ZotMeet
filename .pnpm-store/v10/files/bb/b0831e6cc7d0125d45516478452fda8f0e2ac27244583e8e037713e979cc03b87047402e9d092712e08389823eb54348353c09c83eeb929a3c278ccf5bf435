...
export declare namespace retail_v2alpha {
    ...
    export class Resource$Projects$Locations$Catalogs$Placements {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        conversationalSearch(params: Params$Resource$Projects$Locations$Catalogs$Placements$Conversationalsearch, options: StreamMethodOptions): GaxiosPromise<Readable>;
        conversationalSearch(params?: Params$Resource$Projects$Locations$Catalogs$Placements$Conversationalsearch, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaConversationalSearchResponse>;
    ...
    export class Resource$Projects$Locations$Catalogs$Servingconfigs {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        conversationalSearch(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Conversationalsearch, options: StreamMethodOptions): GaxiosPromise<Readable>;
        conversationalSearch(params?: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Conversationalsearch, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaConversationalSearchResponse>;
