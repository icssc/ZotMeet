...
export declare namespace alloydb_v1beta {
    ...
    export class Resource$Projects$Locations$Clusters {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        import(params: Params$Resource$Projects$Locations$Clusters$Import, options: StreamMethodOptions): GaxiosPromise<Readable>;
        import(params?: Params$Resource$Projects$Locations$Clusters$Import, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
