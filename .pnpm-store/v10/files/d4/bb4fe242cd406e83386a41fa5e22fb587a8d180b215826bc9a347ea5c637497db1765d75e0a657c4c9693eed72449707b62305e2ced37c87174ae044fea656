 ...
 */
export declare const getParsedDebugAddress: (address: string | boolean | undefined) => DebugAddress;
/**
...
export declare function getParsedNodeOptions(): Record<string, string | boolean | undefined>;
/**
 ...
 */
export declare function getNodeDebugType(nodeOptions: NodeOptions): NodeInspectType;
/**
