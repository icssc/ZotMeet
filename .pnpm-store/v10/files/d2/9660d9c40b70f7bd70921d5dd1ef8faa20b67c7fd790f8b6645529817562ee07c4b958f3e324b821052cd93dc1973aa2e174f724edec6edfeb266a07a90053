...
export declare namespace civicinfo_v2 {
    ...
    export class Resource$Divisions {
         ...
         */
        queryDivisionByAddress(params: Params$Resource$Divisions$Querydivisionbyaddress, options: StreamMethodOptions): GaxiosPromise<Readable>;
        queryDivisionByAddress(params?: Params$Resource$Divisions$Querydivisionbyaddress, options?: MethodOptions): GaxiosPromise<Schema$DivisionByAddressResponse>;
        ...
        queryDivisionByAddress(params: Params$Resource$Divisions$Querydivisionbyaddress, options: MethodOptions | BodyResponseCallback<Schema$DivisionByAddressResponse>, callback: BodyResponseCallback<Schema$DivisionByAddressResponse>): void;
        queryDivisionByAddress(params: Params$Resource$Divisions$Querydivisionbyaddress, callback: BodyResponseCallback<Schema$DivisionByAddressResponse>): void;
        queryDivisionByAddress(callback: BodyResponseCallback<Schema$DivisionByAddressResponse>): void;
        /**
