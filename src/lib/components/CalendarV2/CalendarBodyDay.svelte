...
<p
  class={cn(
    ...
    calendarDay.isSelected &&
      "rounded-xl bg-primary text-gray-light drop-shadow-[0_0px_16px_rgba(55,124,251,0.4)]",
    isHighlighted && "rounded-xl bg-slate-base text-gray-dark drop-shadow-none",
  )}
