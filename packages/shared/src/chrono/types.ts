/**
 * Calendar and clock vocabulary shared by the web app and the Expo app.
 *
 * Moved here verbatim from the web app's `src/lib/types/chrono.ts`, which now
 * re-exports from this module so its importers did not have to change.
 */
